  ...
  return (
    <section className="bg-achtergrond pb-20 pt-32 md:pb-28 md:pt-40">
      ...
      >
        ...
        <p className="mt-6 text-xl font-medium text-secundair md:text-2xl">{t.hero.subtitel}</p>
        <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-secundair">{t.hero.intro}</p>
        <button
          type="button"
