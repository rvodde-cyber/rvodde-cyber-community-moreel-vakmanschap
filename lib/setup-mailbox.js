/**
 * Prefers Upstash Redis (Vercel Marketplace: Upstash for Redis) when REST
 * credentials exist. Falls back to a file/memory store for local development
 * and unit tests. The store never inspects ciphertext — only opaque strings + TTL.
 */
