"""Genereer losse .docx per DL COMPLEET A5-kaart (NL + EN)."""
import json
...
OUT_DIR = ROOT / "public/downloads/gesprekskaarten/dl-compleet-a5"
SET_ID = "dl-compleet-a5"
...
CATEGORY_LABELS = {
    "nl": {"dagelijks-leven": "Dagelijks leven"},
    "en": {"dagelijks-leven": "Daily life"},
}
