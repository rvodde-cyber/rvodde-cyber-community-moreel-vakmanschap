"""Genereer losse .docx per onderzoeksintegriteit kaart (NL + EN)."""
import json
...
OUT_DIR = ROOT / "public/downloads/gesprekskaarten/onderzoeksintegriteit"
SET_ID = "onderzoeksintegriteit"
...
CATEGORY_LABELS = {
    "nl": {"onderzoeksintegriteit": "Onderzoeksintegriteit"},
    "en": {"onderzoeksintegriteit": "Research integrity"},
}
